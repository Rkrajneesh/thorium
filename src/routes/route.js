...
router.get('/test-my', function (req, res) {
    let names = [ '', 'Arpit', 'Akash', 'Sabiha']
    //Module 1 members
    ...
    let movie1 = ['horror', 'The conjuring']
    let movie2 = ['drama','Namaste London']
    let movie3 = ['thriller','Talash']
    let movie4 = ['comedy','hera pheri']
